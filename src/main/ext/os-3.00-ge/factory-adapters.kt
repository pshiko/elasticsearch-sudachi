...
// OpenSearch 3.0+ compatibility layer
// Handles API changes from OpenSearch 2.x to 3.x
...
abstract class AbstractTokenFilterFactory(
    ...
    name: String?,
    settings: Settings?
) : org.opensearch.index.analysis.AbstractTokenFilterFactory(indexSettings, name, settings)
...
abstract class AbstractIndexAnalyzerProvider<T : Analyzer>(
    ...
    name: String?,
    settings: Settings?
) : org.opensearch.index.analysis.AbstractIndexAnalyzerProvider<T>(indexSettings, name, settings)